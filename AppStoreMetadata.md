...
**Alternatives:**
- "Cosmo Trader - Star Portfolio" (if name availability issues)
- "CosmicTrader" (single word variant)

**Reasoning:** Clean, memorable, hints at both cosmic/astrology and trading. Under 30 chars.
...
A sleek, OLED-optimized dark interface that looks like a Bloomberg terminal had a baby with a horoscope app. Monospace fonts. Gold accents. Zero ambient light.
...
```
astrology,zodiac,stocks,portfolio,horoscope,investing,finance,trading,moon,cosmic,compatibility
```

**Character Count:** 95 characters

**Alternative Sets:**
- `zodiac,stocks,astrology,portfolio,horoscope,investing,star sign,trading,moon phases,finance`
- `stock tracker,zodiac sign,astrology app,portfolio,horoscope,investing,cosmic,compatibility`
...
**Reasoning:**
- Primary as Finance to reach target users searching for stock/portfolio apps
- Secondary as Entertainment to set expectations and cover the astrology angle
- Alternative: Lifestyle as secondary (if Entertainment seems off-brand)
...
| Profanity or Crude Humor | Infrequent/Mild (roasts may have mild humor) |
...
**Expected Rating:** 4+ or 9+ (depending on roast content interpretation)

**Note:** The Cosmic Roast feature contains playful, mildly sarcastic humor but nothing explicit. May warrant 9+ for "Infrequent/Mild Mature/Suggestive Themes" to be safe.
...
Thank you for reviewing Cosmo Trader.

WHAT THIS APP IS:
Cosmo Trader is an entertainment/lifestyle app with a stock portfolio tracking feature. It combines real stock market data with astrological/zodiac themes for entertainment purposes.

IMPORTANT CLARIFICATIONS:

1. NOT FINANCIAL ADVICE
This app is explicitly NOT a financial advisory service. We display multiple disclaimers throughout the app stating that:
- Content is for entertainment only
- Users should consult qualified financial advisors
- Astrological content has no scientific basis for predicting markets

2. NO TRADING FUNCTIONALITY
The app does NOT connect to brokerages, execute trades, or handle any real money transactions (except optional subscription via StoreKit). It is purely a tracker and entertainment platform.

3. DATA SOURCE
Stock market data is provided by Finnhub.io API with proper attribution displayed in the app. Data may be delayed up to 15 minutes.

4. ASTROLOGICAL CONTENT
...
TEST ACCOUNT:
No account required. The app works immediately upon launch. Onboarding asks for birth date (for zodiac calculation only, stored locally).

KEY SCREENS TO REVIEW:
- Profile > Not Financial Advice (full disclaimer)
- Profile > About Cosmo Trader (attribution)
- Any horoscope/compatibility screen (entertainment disclaimers)

We're happy to answer any questions or make adjustments if needed.
...
### Screenshot Copy Style:
- Large, bold headline
- Short supporting text
- Phone frame mockup (optional)
- Dark backgrounds to match app aesthetic
...
**Storyboard:**
```
0-3s:   Logo animation / "Cosmo Trader"
3-7s:   Portfolio view scrolling, showing zodiac badges
...
**Audio:** Subtle ambient music, no voiceover (matches terminal aesthetic)
