...
struct StockDetailView: View {
        ...
        ScrollViewReader { proxy in
            ScrollView(showsIndicators: false) {
                VStack(spacing: 24) {
                    ...
                    if stock.hasCEOInfo {
                        CEOAstroProfileSection(
                            stock: stock,
                            user: user,
                            hasAppeared: appearAnimation,
                            framedCEOInsight: framedCEOInsight,
                            userElementColor: userElementColor
                        )
                    }
            ...
            .freeTierPaywall(isPresented: $showPaywall, source: FreeTierPaywallSource.watchlistSize)
    ...
    private func addToWatchlist() {
        ...
        } else if appState.addToWatchlist(stock.symbol) {
