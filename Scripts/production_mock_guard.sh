...
require_present "Cosmo Trader/ViewModels/HistoricalAstroChartViewModel.swift" "fetchHistoricalPriceResult"
...
require_present "Cosmo Trader/ViewModels/PortfolioCorrelationViewModel.swift" "fetchHistoricalPriceResult"
