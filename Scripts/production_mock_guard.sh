...
require_present "Cosmo Trader/Services/TodayMarketHoroscopeComposer.swift" "ADD / IMPORT HOLDINGS"
...
require_present "Cosmo Trader/Views/Components/TodayMarketHoroscopeView.swift" "marketBlock(summary.marketContext)"
